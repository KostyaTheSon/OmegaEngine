...
Pr2D_Line(
           ...
           255,          // Альфа
           PR_DEFAULT ); // Флаги
Pr2D_Line( 200, 0, 0, 100, 0x00FF00, 255, PR_SMOOTH );
...
Pr2D_Rect( 200, 0,    // Координаты левого верхнего угла
           ...
           255,       // Альфа
           PR_FILL ); // Флаги
Pr2D_Rect( 200, 50, 100, 50, 0xFFFFFF, 255, PR_DEFAULT );
...
Pr2D_Circle( 350, 50,      // Координаты центра окружности
             ...
             PR_DEFAULT ); // Флаги
Pr2D_Circle( 450, 50, 50, 0xFF0000, 255, 32, PR_FILL );
...
Pr2D_Ellipse(
              ...
              32,           // Качество
              PR_DEFAULT ); // Флаги
Pr2D_Ellipse( 750, 100, 50, 100, 0xFFFFFF, 255, 32, PR_FILL );
}
